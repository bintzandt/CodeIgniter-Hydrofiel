...
<?= form_open_multipart( $edit_mode ? "agenda/update_details" : "/agenda/nszk_inschrijven", [
...
<div class="form-group">
	...
	<div class="col-sm-8">
		<input type="radio" id="groep_heen" name="groep_heen" value="0"
		       required <?= $edit_mode && $details->groep_heen == 0 ? 'checked' : '' ?>> <?= lang( 'agenda_yes_friday' ) ?>
		<input type="radio" name="groep_heen" value="1"
		       required <?= $edit_mode && $details->groep_heen == 1 ? 'checked' : '' ?>> <?= lang( 'agenda_yes_saturday' ) ?>
...
<div class="form-group">
	...
	<div class="col-sm-8">
		<input type="radio" id="groep_terug" name="groep_terug" value="0"
		       required <?= $edit_mode && $details->groep_terug == 0 ? 'checked' : '' ?>> <?= lang( 'agenda_yes_saturday' ) ?>
		<input type="radio" name="groep_terug" value="1"
		       required <?= $edit_mode && $details->groep_terug == 1 ? 'checked' : '' ?>> <?= lang( 'agenda_yes_sunday' ) ?>
