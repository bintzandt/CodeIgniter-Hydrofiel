        ...
        <tr style="background: #ffab3a; height: 120px; padding: 7px;">
            ...
            <td  valign="top" style="text-align: left;">
                <p>
                    ...
                    <br>
                    <b>Let op: Deze link vervalt automatisch op <?= date_format(date_create($valid), 'd-m-Y H;i') ?> om <?= date_format(date_create($valid), 'H:i') ?>.</b><br>
                    <br>
                ...
                <p>
                    Dear member,<br>
                    <br>
                    With <a href="<?=site_url('/inloggen/reset/' . $recovery)?>">this</a> url you can reset your password.<br>
                    <br>
                    <b>Be careful: this link will expire on <?= date_format(date_create($valid), 'd-m-Y H:i') ?> at <?= date_format(date_create($valid), 'H:i') ?>.</b><br>
                    <br>
                    If you did not ask to reset your password you can just sit back. If you keep getting these emails please contact <a href="mailto:webmaster@hydrofiel.nl">webmaster@hydrofiel.nl</a>.<br>
                    <br>
                </p>
            </td>
        </tr><tr>
