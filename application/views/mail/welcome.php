        ...
        <tr style="background: #ffab3a; height: 120px; padding: 7px;">
            ...
            <td  valign="top" style="text-align: left;">
                <p>
                    Dear <?= $voornaam ?>,<br>
                    <br>
                    I've processed your application and from today you're officially a member! This means that you'll have
                    access to the Hydrofiel website. With <a href="<?=site_url('/inloggen/reset/'.$recovery)?>">this</a>
                    link you'll be able to make an account for <a href="<?=site_url('')?>">www.hydrofiel.nl</a>. Among other
                    things, you can view the calendar and sign yourself up for events/tournaments/competitions on the website.
                    You can also find the Rules and Regulations, the Articles of Association, and other useful information.<br>
                    <br>
                    From now, you will also receive the newsletter and any other important e-mails, and you'll be kept up-to-date with everything going on.<br>
                    <br>
