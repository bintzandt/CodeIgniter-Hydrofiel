...
<?= $edit_mode ? form_open_multipart( '/beheer/agenda/save', [
	...
	<div class="col-sm-10">
		<div class="input-group date">
			<input type="text" class="form-control" name="inschrijfdeadline" id="inschrijf"
			       value="<?= ( $edit_mode && $event->inschrijfsysteem ) ? date_format( date_create( $event->inschrijfdeadline ), 'd-m-Y H:i' ) : '' ?>"><span
	...
	<div class="col-sm-10">
		<div class="input-group date">
			<input type="text" class="form-control" name="afmelddeadline" id="afmeld"
			       value="<?= ( $edit_mode && $event->inschrijfsysteem && $event->afmelddeadline ) ? date_format( date_create( $event->afmelddeadline ), 'd-m-Y H:i' ) : '' ?>"><span
					class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
		</div>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-10">
		...
		<label class="radio-inline"><input required type="radio" name="betalen"
		                                   value="0" <?= ( $edit_mode && ! $event->betalen ) ? 'checked' : '' ?>>Nee</label>
	</div>
</div>
<div class="form-group">
