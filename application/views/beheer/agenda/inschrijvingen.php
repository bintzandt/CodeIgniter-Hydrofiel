		...
		<?php foreach ( $inschrijvingen as $inschrijving ) { ?>
			<tr>
				<td class="clickable-row"
				    data-href="/beheer/agenda/registration/<?= $event_id ?>/<?= $inschrijving->member_id ?>"><?= $inschrijving->naam ?></td>
				<td class="clickable-row"
				    data-href="/beheer/agenda/registration/<?= $event_id ?>/<?= $inschrijving->member_id ?>"><?= date_format(
						date_create( $inschrijving->datum ),
						'd-m-Y H:i'
					) ?></td>
				<td>
