		...
		<?php foreach ( $events as $event ) { ?>
			<tr>
				<td class="clickable-row"
				    data-href="/beheer/agenda/inschrijvingen/<?= $event->event_id ?>"><?= $event->naam ?></td>
				<td class="clickable-row"
				    data-href="/beheer/agenda/inschrijvingen/<?= $event->event_id ?>"><?= $event->get_formatted_date_string( 'van' ) ?>
				</td>
				<td>
					<a href="/beheer/agenda/edit/<?= $event->event_id ?>"><span class="fa fa-edit"></span></a>
					<a onclick="showModal('<?= $event->naam ?>', <?= $event->event_id ?>)"><span
