...
(function ($) {
  ...
  $.extend($.summernote.options, {
    cleaner: {
      ...
      keepOnlyTags: ['<br>', '<b>', '<strong>','<i>', '<a>', '<sub>', '<sup>', '<u>', '<strike>', '<del>', '<span>'], // If keepHtml is true, remove all tags except these
      keepClasses: false, //Remove Classes
      badTags: ['style', 'script', 'applet', 'embed', 'noframes', 'noscript', 'head', 'xml'], //Remove full tags with contents
      badAttributes: ['style','start', 'lang', 'dir'], //Remove attributes from remaining tags
